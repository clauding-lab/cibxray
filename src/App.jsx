...
export default function App() {
  ...
  const TABS = [
    ...
    { key: "signals", label: "Exposure Analytics" },
    { key: "trends", label: "Behavioral Signals" },
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI',-apple-system,system-ui,sans-serif", background: "#f8fafc", minHeight: "100vh", color: "#0f172a" }}>
      ...
      {infoModal === "methodology" && (
        <InfoModal title="Risk Grading & Score Methodology" onClose={() => setInfoModal(null)}>
          <ScoreExplainer />
        </InfoModal>
      )}
    </div>
